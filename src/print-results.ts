...
export default function printResults(results:LintResultWithTodo[], options: TodoPrintOptions = {}, returnValue?:stylelint.LinterResult):string {
...
function formatter(messages: TodoWarning[], source:string, cwd:string):string {
